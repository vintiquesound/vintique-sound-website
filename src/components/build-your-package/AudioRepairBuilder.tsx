...
export default function AudioRepairBuilder({ onChangeCategory: _onChangeCategory }: AudioRepairBuilderProps) {
  ...
  const requestPackage = React.useMemo(() => {
    const lines: string[] = [];
    lines.push("Service: Audio Repair");
    ...
    return {
      subject: "Package Request — Audio Repair",
      ...
      <div className="md:col-span-2 space-y-8">
        <div className="space-y-0.5">
          ...
          <p className="text-sm text-muted-foreground">
            Audio repair pricing is per track. Each enabled service adds {formatCurrency(PER_SERVICE_BASE)} + a length surcharge.
          </p>
        </div>
          ...
          <section className="space-y-4">
            <div className="rounded-lg border border-border p-4 space-y-4">
              <div className="space-y-2">
                <label className="text-sm font-medium">How many tracks need repair? <span className="text-destructive">*</span></label>
                <input
                  type="number"
                  min={1}
                  value={trackCount}
            ...
            <div className="rounded-lg border border-border p-4 space-y-4">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  placeholder="Example: Track 2 — Verse"
                />
              </div>
                      ...
                      <div className="py-4 space-y-3">
                        ...
                        {cfg.enabled && (
                          <div className="space-y-1">
                            <label className="text-sm text-muted-foreground">Notes / track names</label>
                            <textarea
                              value={cfg.notes}
