...
export const MIXING_AND_MASTERING_TITLE = "Mixing & Mastering Services | Vintique Sound";
export const MIXING_AND_MASTERING_DESCRIPTION = "Professional mixing and mastering services for Indie Rock, Classic Rock, Hard Rock, House Music, and more. Includes up to 3 revisions, with an optional unlimited revisions add-on for added flexibility.";
...
export const PRESETS_AND_TEMPLATES_TITLE = "Presets & Templates | Vintique Sound";
