...
export const resume = [
  ...
  {
    year: "2022 - 2025",
    context: "Formal education (audio and web development coding skills)",
    title: "Bachelor of Computer Science",
    company: "MacEwan University",
    description:
      "Completed a Computer Science degree with emphasis on AI & machine learning, systems programming, operating systems, and web development. Built a strong mathematical foundation in linear algebra and calculus, directly supporting advanced audio signal processing, tooling, and performance-oriented software design."
  },
  {
    year: "2012 - 2018",
    context: "Part-time professional experience",
  ...
  {
    year: "2011 - 2017",
    context: "Formal education (critical thinking and communication skills)",
    title: "Bachelor of Arts (Philosophy & Psychology)",
    company: "MacEwan University",
    description:
      "Studied philosophy and psychology, developing strong analytical thinking and communication skills. This academic background informs my approach to teaching, client collaboration, problem-solving, and the human-centered design of technical and creative systems."
  }
];
